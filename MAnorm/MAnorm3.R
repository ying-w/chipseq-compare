...
table_MA[,9] = round(normalized_all_count_mat[,1])
table_MA[,10] = round(normalized_all_count_mat[,2])
table_MA[,11] = round(normalized_all_count_mat[,3])
table_MA[,12] = round(normalized_all_count_mat[,4])
...
table_merge_MA[,9] = round(normalized_all_merge_count_mat[,1])
table_merge_MA[,10] = round(normalized_all_merge_count_mat[,2])
table_merge_MA[,11] = round(normalized_all_merge_count_mat[,3])
table_merge_MA[,12] = round(normalized_all_merge_count_mat[,4])
